...
version = 7.8.0
requirements = python3,kivymd==1.2.0,kivymd,requests,urllib3,openssl,pillow,arabic-reshaper,python-bidi==0.4.2,six,future,certifi,chardet,idna,pyzbar,libzbar,android,jnius,plyer
